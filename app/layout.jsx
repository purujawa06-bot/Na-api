...
export const metadata = {
  metadataBase: new URL('https://tiyanz-api.vercel.app'),
  title: {
  ...
  publisher: 'Tiyanz',
  alternates: {
    canonical: 'https://tiyanz-api.vercel.app',
  },
  openGraph: {
    ...
    images: [
      {
        url: 'https://tiyanz-api.vercel.app/og',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    creator: '@tiyanz',
    images: ['https://tiyanz-api.vercel.app/og'],
  },
  robots: {
    index: true,
    follow: true,
