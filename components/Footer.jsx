...
export default function Footer() {
    ...
    // Sembunyikan footer di halaman chat, docs, support, dan purtv
    if (pathname === '/chat' || pathname.startsWith('/docs') || pathname === '/support' || pathname.startsWith('/purtv')) return null;
