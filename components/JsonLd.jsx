    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'PuruAI Chat', item: 'https://puruboy-api.vercel.app/puruai' },
          { '@type': 'ListItem', position: 5, name: 'Chat Room', item: 'https://puruboy-api.vercel.app/chat' },
        ],
      },
    ],
  };
