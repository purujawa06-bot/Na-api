...
// baca via fs (bukan import statis) supaya file ini juga bisa dijalankan langsung oleh node ESM
const tpl = JSON.parse(readFileSync(join(__dirname, 'gemini-freq-template.json'), 'utf8'));
