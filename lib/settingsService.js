...
/** ID provider yang sah untuk rantai auto (harus sinkron dgn lib/ai-provider-web.js). */
const AUTO_CHAIN_ALLOWED = ['gemini-lite', 'deepseek-v4', 'easemate'];
/** Urutan default: Gemini Flash-Lite dulu, fallback DeepSeek V4 (NoteGPT), lalu EaseMate. */
const AUTO_CHAIN_DEFAULT = ['gemini-lite', 'deepseek-v4', 'easemate'];
