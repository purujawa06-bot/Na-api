 ...
 * tanpa eksekusi challenge — lebih robust dari cloudscraper. Wajib external di
 * next.config.js (`serverComponentsExternalPackages`) supaya tidak dibundling
 * webpack (browserslist memakai require dinamis yang merusak chunk Next).
 */
