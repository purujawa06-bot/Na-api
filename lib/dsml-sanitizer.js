 ...
 * menjadi format UI-TARS XML sebelum sampai ke uiTarsToolMiddleware.
 *
 * Latar belakang: DeepSeek kadang mengabaikan instruksi
 * protokol UI-TARS dan memakai bias training-nya sendiri (markup internal
 ...
 *   - "qwen" (default): (UI-TARS XML format)<tool_call><function=x><parameter=p>v</parameter>...</function></tool_call>
 */
...
/**
 * Middleware sanitizer dengan target protokol output ("qwen" default | "morph" legacy).
