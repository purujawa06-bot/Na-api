 ...
 * Reverse-eng via CDP sniff (bukti di folder opencode temp):
 *
 *   1. (implisit) Bypass Cloudflare "Just a moment" -> lib/cloudscraper.js
 *      (tiruan cloudscraper@4.6.0 npm berbasis fetch + tough-cookie;
