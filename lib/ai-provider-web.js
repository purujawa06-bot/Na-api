...
// ---------------- Puru (OpenCode Zen OpenAI-compatible) ----------------

/**
 * Model upstream free 'big-pickle' pada OpenCode Zen endpoint OpenAI-compatible,
 * dibungkus jadi id publik 'puru'. Streaming real (SSE upstream dipompa
 * ke part LanguageModelV4) — pola sama dengan EaseMate.
 * Konfigurasi: PURUBOY_PURU_BASE_URL (default https://opencode.ai/zen/v1)
